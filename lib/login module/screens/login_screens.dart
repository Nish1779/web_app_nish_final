...
import 'package:web_app_nish/main.dart';

class LoginScreen extends StatefulWidget {
  const LoginScreen({Key? key, required void Function() onClickedSignUp}) : super(key: key);
            ...
            children: [
              ...
              GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) {
                      return SignUpScreen(onClickedSignIn: () {  },);
                    }));
                  },
                  child: Text(
                    "New user? Sign up",
